...
# "lines_bars_and_markers example code: fill_domo.py, "Matplotlib 1.5.0 documentation. [Online]. Available:
...
# data 준비 시작
# x data 생성 : 0 부터 1 사이클 500 구간으로 나눔
x = np.linspace(0, 1, 500)
# y data 생성 : exp() 한수와 sin() 함수의 곱으로 생성
# x와 같은 수의 data 를 생성함
# >>> print len(x)
# >>> print len(y)
# 위 두 결과가 같을 것임
